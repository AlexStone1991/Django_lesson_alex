...
class Order(models.Model):
    ...
    service = models.ManyToManyField("Service", verbose_name="Услуга", default=None, related_name="orders")
...
class Master(models.Model):
    ...
    service = models.ManyToManyField("Service", verbose_name="Услуга", default=None, related_name="masters")
